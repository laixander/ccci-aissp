                            ...
                            <div class="space-y-4 mt-4">
                                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                    <UFormField label="System Name" size="lg" required class="col-span-3 lg:col-span-4">
                                        <UInput class="w-full"
                                            placeholder="e.g. Disaster Resilience Informatics Platform" />
                                    </UFormField>
                        ...
                        <UCard variant="soft" class="my-4">
                            ...
                            <div class="space-y-4 mt-4">
                                ...
                                <UFormField label="Associated Modules" size="lg">
                                    <UTextarea :rows="4" placeholder="e.g. Enrollment, Payroll, Billing"
                                        class="w-full" />
                                </UFormField>
                            </div>
                        </UCard>
                            ...
                            <div class="space-y-4 mt-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <UFormField label="Performance Metrics" size="lg">
                                        <UInput placeholder="e.g. SLA %, Uptime %, Client Satisfaction"
                                            class="w-full" />
                                    </UFormField>
                                </div>
                            </div>
                        ...
                        <UCard variant="soft" class="my-4">
                            ...
                            <div class="space-y-4 mt-4">
                                <UFormField label="Security Features" size="lg">
                                    <UTextarea :rows="4" placeholder="e.g. MFA, encryption, audit logs"
                                        class="w-full" />
                                </UFormField>
